const transformToBackendPayload = (nodes, edges) => {
    ...
    const connections = edges.map(edge => {
        ...
        for (const card of network_elements.find(ne => ne.id === sourceNE.id).cards) {
        ...
        for (const card of network_elements.find(ne => ne.id === targetNE.id).cards) {
